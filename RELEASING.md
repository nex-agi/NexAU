...
This document describes how to create a new release of the Northau framework.
...
1. Go to the [Actions tab](https://github.com/china-qijizhifeng/northau/actions)
...
- Check [GitHub Releases](https://github.com/china-qijizhifeng/northau/releases) for the release notes
- Test installation: `pip install northau==0.2.0`
...
1. Delete the GitHub release from the [Releases page](https://github.com/china-qijizhifeng/northau/releases)
2. Delete the tag:
   ```bash
   git tag -d v0.2.0
