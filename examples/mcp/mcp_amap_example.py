...
Explain what you're doing and provide context for the results.""",
        ...
        if agent.tools:
            ...
            print("     This is expected behavior as the Amap MCP server used in this example")
            print("     is not currently accessible or may require different authentication.")
            print()
            ...
            print("        The timeout has been reduced from 30s to 10s for faster failure detection.")
