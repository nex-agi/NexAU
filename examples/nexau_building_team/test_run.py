...
def main():
    ...
    try:
        ...
        claude_code_agent = Agent.from_yaml(config_path=script_dir / "builder_agent.yaml")
        ...
        print("\nTesting Code Agent...")
        user_messages = [
            Message(content=[TextBlock(text="write a python code to print 'Hello, World!'")], role=Role.USER),
            Message(content=[TextBlock(text="write a python code to print 'Hello, World!'")], role=Role.USER),
        ]
