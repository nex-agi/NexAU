...
| [RFC-0027](./0027-agent-workflow-orchestration.md) | Agent Workflow 编排与结构化输出 | implemented | P1 |
| [RFC-0028](./0028-workflow-subgraph-support.md) | Workflow 子图支持 | implemented | P1 |
| [RFC-0029](./0029-workflow-parallel-map-execution.md) | Workflow 并行 Map 与结果收集 | draft | P1 |
| [RFC-0030](./0030-workflow-agent-event-streaming.md) | Workflow 与 Agent 事件统一流式输出 | implemented | P1 |
