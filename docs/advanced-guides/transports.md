...
1. **Use environment variables** for configuration:
   ```bash
   export NEXAU_DB_URL="sqlite+aiosqlite:///sessions.db"
...
- [Streaming Events](./streaming-events.md) — Event types, lifecycles, and handler patterns for streaming UIs.
- [Session Management](./session-management.md) — Storage backends, locking, and session configuration.
