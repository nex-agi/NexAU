...
* **Advanced Guides**
    ...
    * **[Workflows](./advanced-guides/workflows.md)** ⚠️ *Experimental*: Durable YAML workflows with structured agent outputs, human checkpoints, subgraphs, and parallel map execution.
