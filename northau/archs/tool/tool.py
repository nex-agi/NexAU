...
class Tool:
    ...
    def from_yaml(
        ...
        **kwargs,
        ...
        if 'agent_state' in input_schema:
            raise ValueError(
                f"Tool definition of `{name}` contains 'agent_state' field in {yaml_path}, which will be injected by the framework, please remove it from the tool definition.",
            )
    ...
    def validate_params(self, params: dict) -> bool:
        ...
        schema_params = {
            k: v for k,
            v in params.items() if k in schema_properties
        }
