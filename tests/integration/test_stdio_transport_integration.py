...
"""Integration tests for Stdio transport with mocked agent."""
...
class TestStdioTransportQueryIntegration:
    """Integration tests for stdio transport query method."""
    ...
    def test_handle_sync_request_success(self, transport):
        """Test _handle_sync_request_model with mocked handler."""
...
class TestStdioTransportStreamIntegration:
    """Integration tests for stdio transport streaming."""
    ...
    def test_handle_streaming_request_success(self, transport):
        """Test _handle_streaming_request_model with mocked streaming handler."""
...
class TestStdioTransportHandleLine:
    """Integration tests for _handle_line with different methods."""
