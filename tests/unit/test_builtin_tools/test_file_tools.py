...
class TestFileEditTool:
    ...
    def test_update_existing_file(self, temp_file):
    ...
    def test_no_change_error(self, temp_file):
...
class TestFileReadTool:
    ...
    def test_read_text_file(self, temp_file):
    ...
    def test_read_large_file_truncation(self, temp_file):
...
class TestGlobTool:
    ...
    def test_glob_with_limit(self, temp_dir):
...
class TestLSTool:
    ...
    def test_ls_directory(self, temp_dir):
    ...
    def test_ls_with_ignore_patterns(self, temp_dir):
...
class TestGrepTool:
    ...
    def test_grep_search_in_files(self, temp_dir):
    ...
    def test_grep_with_file_pattern(self, temp_dir):
...
class TestFileToolsIntegration:
    ...
    def test_read_edit_write_cycle(self, temp_dir):
